...
public class Player extends Actor{
	...
	public Player(Scene scene, Texture tex, int x) {
		...
		super.setAbilities(new Ability[]{
				new BasicAttack(this, new TextureRegion(new Texture(Gdx.files.internal("knights/abilities_signs.png"))), new TextureRegion(new Texture(Gdx.files.internal("knights/abilities.png")), 16, 0, 16, 8), tex, 16, 0, Scale, SrcWidth, SrcHeight),
				new BasicAbility(this, new TextureRegion(new Texture(Gdx.files.internal("knights/abilities_signs.png")), 0, 0, 16, 16), new TextureRegion(new Texture(Gdx.files.internal("knights/abilities.png")), 16, 0, 16, 8), "Ability_2", 16*Scale+16, 0, Scale),
				new BasicAbility(this, new TextureRegion(new Texture(Gdx.files.internal("knights/abilities_signs.png")), 0, 0, 16, 16), new TextureRegion(new Texture(Gdx.files.internal("knights/abilities.png")), 16, 0, 16, 8), "Ability_3", 32*Scale+16, 0, Scale),
				new BasicAbility(this, new TextureRegion(new Texture(Gdx.files.internal("knights/abilities_signs.png")), 0, 0, 16, 16), new TextureRegion(new Texture(Gdx.files.internal("knights/abilities.png")), 16, 0, 16, 8), "Ability_4", 48*Scale+16, 0, Scale),
				new BasicAbility(this, new TextureRegion(new Texture(Gdx.files.internal("knights/abilities_signs.png")), 0, 0, 16, 16), new TextureRegion(new Texture(Gdx.files.internal("knights/abilities.png")), 16, 0, 16, 8), "Ability_5", 64*Scale+16, 0, Scale),
				new BasicAbility(this, new TextureRegion(new Texture(Gdx.files.internal("knights/abilities_signs.png")), 0, 0, 16, 16), new TextureRegion(new Texture(Gdx.files.internal("knights/abilities.png")), 32, 0, 16, 8), "Ability_6", 80*Scale+16, 0, Scale)
		});
